...
const Resultado = (props) => {
  ...
  const print = () => {
    ...
    doc.autoTable({
      ...
      head: [['Nombre', 'DNI', 'Cargo', 'Fecha/Hora de realización']],
      body: [[
